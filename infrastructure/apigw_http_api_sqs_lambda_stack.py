...
class ApigwHttpApiSqsLambdaStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Outputs
        CfnOutput(self, "API Endpoint", description="API Endpoint",
    ...
    def _create_stage(self):
        _stage = _apigwv2.CfnStage(
            self, 'HttpToSqsStage', api_id=self._http_api.ref, stage_name='$default', auto_deploy=True)
        return _stage
